...
<head>
	...
	<link rel="icon" href="images/favicon.ico" type="ico.png">
...
<body>
	...
	<div id="content">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3"><!-- Profile Start -->
					<?php 
				...
				<div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
					<div class="box margin-top-side-menu">
						...
						<form action="confirm.php?update_id=<?php echo($order_id); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="invoice_no" value="<?php echo $row_orders['invoice_no'] ; ?>" readonly required>
							</div>

							<div class="form-group">
								<label>Amount Sent:</label>
								<input class="form-control" type="number" name="amount_sent" value="<?php echo $row_orders['due_amount'] ; ?>" readonly required>
							</div>

							<div class="form-group">
								<label for="payment_method">Select Payment Mode:</label>
								<select class="form-control" id="payment_method" name="payment_mode">
							...
							<div class="form-group">
								...
								<input class="form-control" type="number" name="ref_no" required>
							</div>
							...
							<div class="text-center">
								<button class="btn btn-outline-primary btn-lg" type="submit" name="confirm_payment">
									<i class="fas fa-money-bill-wave-alt"></i> Confirm Payment
								</button>
							</div>
						...
						<?php 
							...
							if (isset($_POST["confirm_payment"])) 
							{
								...
								if ($run_pending_order) 
								{
									...
									"
										<script>
											alert('Thank You for purchasing, your order will be completed within 24 hours work');
										</script>
									";
